...
smstable<-read.csv("C:/tmp/smsspamcollection.txt", header = TRUE, sep = "\t", colClasses=c("type"="character","sms"="character"))
...
#select the percent od data that you want to use as training set
trdatapercent<-0.3
